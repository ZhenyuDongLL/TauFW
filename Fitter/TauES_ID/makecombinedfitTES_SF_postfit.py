...
def main(args):
    ...
    run_combined_fit(setup,setup_mumu, era=era, config=config, config_mumu=config_mumu, option=option, mumu_input_file=args.mumu_input_file, jet_wp=args.jet_wp, ele_wp=args.ele_wp)
