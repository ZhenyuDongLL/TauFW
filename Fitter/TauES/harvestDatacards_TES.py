...
if __name__ == '__main__':
  ...
  parser.add_argument('-y', '--year', dest='year', choices=['2016','2017','2018','UL2016_preVFP','UL2016_postVFP','UL2017','UL2018', '2024'], type=str, default=2018, action='store', help="select year")
