...
# 定义一个此作业专用的日志文件
LOG_FILE="condor_job_output_${DECAY_MODE}_single.log"
echo ""
...
python3 TauES/createinputsTES_v2.py \
    -y 2024 \
    -o input_dzytest_upart_v5_single \
...
LOCAL_OUTPUT_PATH="input_dzytest_upart_v5_single/againstjet_Medium/againstelectron_VVLoose/rebinning/${OUTPUT_BASENAME}"
